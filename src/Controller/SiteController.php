...
use App\Repository\ExhibitionRepository; // Import the repository
...
class SiteController extends AbstractController
{
    ...
    /**
     * Explore page (show exhibitions, or content related to Explore)
     */
    #[Route('/explore', name: 'app_explore', methods: ['GET'])]
    public function explore(): Response
    {
        return $this->render('site/explore.html.twig');
    }

    /**
     * Exhibitions page (show list of exhibitions)
     */
    #[Route('/exhibitions', name: 'app_exhibitions', methods: ['GET'])]
    public function exhibitions(ExhibitionRepository $exhibitionRepository): Response
    {
        // Fetch all exhibitions using the ExhibitionRepository
        $exhibitions = $exhibitionRepository->findActive();  // Or use other methods like findUpcoming, etc.

        return $this->render('site/exhibitions.html.twig', [
